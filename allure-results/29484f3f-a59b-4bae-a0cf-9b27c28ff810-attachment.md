...
- Name: datadriven.spec.ts >> Login Test with username: performance_glitch_user and password: undefined
...
- generic [ref=e3]:
  ...
  - generic [ref=e5]:
    - generic [ref=e9]:
      - textbox "Username" [active] [ref=e11]: performance_glitch_user
